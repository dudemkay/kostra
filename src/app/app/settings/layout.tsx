...
import { TabNavigation, TabNavigationLink } from '@/components/molecules/common/TabNavigation';

const navigationSettings = [{ name: 'Users', href: siteConfig.baseLinks.settings.users }];
