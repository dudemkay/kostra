...
export default function Billing() {
  ...
  const { openBillingPortal, checkout, isCreatingPortal, isCreatingCheckout } = useStripe();
    ...
    <>
      ...
      <div className="mt-6 space-y-10">
        <div className="flex flex-wrap items-center gap-2">
          <Button variant="primary" disabled={isCreatingPortal} onClick={openBillingPortal}>
          ...
          <Button
            ...
            className={
              isFreePlan
                ? 'shadow-lg shadow-indigo-500/30 ring-2 ring-indigo-500 ring-offset-2'
                : undefined
            }
                    ...
                    <div>
                      {isSpendMgmtEnabled ? (
                        <>
                          ...
                          <Label htmlFor="spend-mgmt" className="text-gray-500 dark:text-gray-500">
                ...
                <Card className="overflow-hidden p-0">
                  <div className="px-4 pb-6 pt-4">
                    ...
                    <p className="mt-2 max-w-xl text-sm leading-6 text-gray-500">
                      Safeguard your assets with our cutting-edge bot protection. Our AI solution
                      identifies and mitigates automated traffic to protect your workspace from bad
                      bots.
                    </p>
                  </div>
