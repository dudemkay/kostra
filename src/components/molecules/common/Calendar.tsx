    ...
    return (
      <button
        ...
        className={cx(
          ...
          'border-border',
          // background color
          'hover:bg-background-light active:bg-background-dark',
          // disabled
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: 'w-9 font-medium text-sm sm:text-xs text-center text-text-muted pb-2',
        row: 'w-full mt-0.5',
        cell: cx('relative p-0 text-center focus-within:relative', 'text-text'),
        day: cx(
          'size-9 rounded text-sm text-text focus:z-10',
          'hover:bg-background-light',
          focusRing
        ),
        day_today: 'font-semibold',
        day_selected: cx('rounded', 'aria-selected:bg-primary aria-selected:text-white'),
        day_disabled: '!text-text-muted line-through disabled:hover:bg-transparent',
        day_outside: 'text-text-muted',
        day_range_middle: cx(
          '!rounded-none',
          'aria-selected:!bg-background-light aria-selected:!text-text'
        ),
          ...
          return (
            <div className="flex items-center justify-between">
              ...
              <div
                role="presentation"
                aria-live="polite"
                className="text-sm font-medium capitalize tabular-nums text-text"
              >
