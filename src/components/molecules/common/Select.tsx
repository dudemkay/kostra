...
const selectTriggerStyles = [
  cx(
    ...
    // background color - using bg-light for dropdowns
    'bg-background-light',
    // hover
    'hover:bg-background',
    // disabled
    'data-[disabled]:bg-background-light data-[disabled]:text-text-muted',
    focusInput
    // invalid (optional)
      ...
      <SelectPrimitives.Icon asChild>
        <RiArrowDownSLine
          className={cx(
            ...
            'text-text-muted',
            // disabled
            'group-data-[disabled]/trigger:text-text-muted'
          )}
        />
  ...
  (
    ...
    <SelectPrimitives.Portal>
      <SelectPrimitives.Content
        ...
        className={cx(
          // base
          'shadow-black/[2.5%] relative z-50 overflow-hidden rounded-md border shadow-xl',
          // widths
  ...
  return (
    ...
    >
      ...
      <SelectPrimitives.ItemIndicator>
        <RiCheckLine className="size-5 shrink-0 text-text" aria-hidden="true" />
      </SelectPrimitives.ItemIndicator>
    </SelectPrimitives.Item>
  );
});
...
>(({ className, children, period, ...props }, forwardedRef) => {
  return (
    <SelectPrimitives.Item
      ...
      className={cx(
        // base
        'relative flex cursor-pointer items-center rounded py-2 pl-8 pr-3 outline-hidden transition-colors data-[state=checked]:font-semibold sm:text-sm',
        // text color
